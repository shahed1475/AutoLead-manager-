...
// Client-portal API: talks only to /api/portal/* with the client's own
// session token (never the owner's). A 401 signs the client out.
...
export const portalApi = {
  ...
  requestCode: (email) => api.post('/auth/request-code', { email }).then((r) => r.data),
